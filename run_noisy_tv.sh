#!/bin/bash
declare -a test_cases=("HalfPreTrain") # "NoPreTrain" "QuarterPreTrain"  "ThreeQuarterPreTrain"
declare -a methods=("AEGIS_min_max_FDM_IDM")
declare -a arr=("DoorKey-8x8") # "BlockedUnlockPickup" "DoorKey-16x16" "FourRooms" "MultiRoom-N4-S5" "MultiRoom-N6" "KeyCorridorS4R3" "KeyCorridorS6R3"
